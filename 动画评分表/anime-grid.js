...
<div class="search-bangumis-box ui-shadow" data-show="false">
    <div class="content-box">
        <form>
            <input type="text" placeholder="输入动画名称后可点击下方“🔍调用番组计划 API 搜索”喵~">
        </form>
        <div class="anime-list"></div>
        <div class="foot">
            <a class="close ui-btn" action="searchFromBangumi">🔍调用番组计划 API 搜索</a>
            <a class="close ui-btn" action="setInputText">𝕋 没找到，就用搜索框里的文字了</a>
            <a class="close ui-btn" action="setNull">∅ 设为空</a>
